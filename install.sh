...
install_XrayR() {
    ...
    file="https://raw.githubusercontent.com/weongit/XrayR/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/weongit/XrayR/master/XrayR.sh
